...
const initialMockEncounters: Encounter[] = [
  {
    ...
    patient: {
      id: 'pat-001',
      name: 'Pasien Contoh A',
      age: 45,
      gender: 'L',
      mrn: 'RM-DEMO-01',
      nik: 'ID-DEMO-01',
      bpjsStatus: 'NONAKTIF',
      bpjsNumber: 'BPJS-DEMO-01',
      bloodType: 'O+',
      allergies: [
        {
  ...
  },
  {
    ...
    patient: {
      id: 'pat-002',
      name: 'Pasien Contoh B',
      age: 34,
      gender: 'P',
      mrn: 'RM-DEMO-02',
      nik: 'ID-DEMO-02',
      bpjsStatus: 'NONAKTIF',
      bpjsNumber: 'BPJS-DEMO-02',
      bloodType: 'B+',
      allergies: [],
      fallRisk: 'RENDAH',
  ...
  },
  {
    ...
    patient: {
      id: 'pat-003',
      name: 'Pasien Contoh C',
      age: 8,
      gender: 'L',
      mrn: 'RM-DEMO-03',
      nik: 'ID-DEMO-03',
      bpjsStatus: 'NONAKTIF',
      bpjsNumber: 'BPJS-DEMO-03',
      bloodType: 'A+',
      allergies: [
        {
          substance: 'Sulfa',
          severity: 'SEDANG',
          reaction: 'Gatal dan urtikaria',
        },
      ],
      fallRisk: 'RENDAH',
  ...
  },
  {
    ...
    patient: {
      id: 'pat-004',
      name: 'Pasien Contoh D',
      age: 58,
      gender: 'L',
      mrn: 'RM-DEMO-04',
      nik: 'ID-DEMO-04',
      bpjsStatus: 'NONAKTIF',
      bpjsNumber: 'BPJS-DEMO-04',
      bloodType: 'AB+',
      allergies: [],
      fallRisk: 'SEDANG',
    ...
    prescriptions: [
      ...
      },
      {
        ...
        dosage: '3 x 1 tablet bila sakit kepala',
        signa: 'sesudah makan (prn)',
        quantity: 10,
        unit: 'Tablet',
      },
    ],
...
export function PatientJourneyProvider({ children }: { children: React.ReactNode }) {
  ...
  const registerPatient = (payload: RegisterPatientPayload): Encounter => {
    ...
    const queueNumber = `A-${String(queueIndex).padStart(2, '0')}`;
